...
pub fn build_translator_user_msg(
    ...
    s.push_str(
        "<<TASK: แปลเฉพาะข้อความใน SOURCE_JP เป็นภาษาไทยเท่านั้น>>\n\
         ...
         - ใช้ชื่อ/คำเรียกจาก REFERENCE ให้ตรงตัว โดยเฉพาะรายการ \"เรียกอีกชื่อ\" เช่น JP surface ใดมีรูปไทยกำกับ ต้องใช้รูปนั้น ห้ามสลับกับชื่อหลักหรือสะกดเองใหม่\n\
         - ถ้า SOURCE_JP มี `俺` ในข้อความเล่าเรื่องหรือบทพูด ให้ถือเป็นสัญญาณเสียงชาย/กันเองก่อนเสมอ ห้ามใช้ \"ฉัน\" เว้นแต่ REFERENCE/CHARACTERS หรือบริบทระบุชัดว่าตัวละครชายคนนั้นใช้ \"ฉัน\"; อย่าลากสรรพนามจาก CONTINUITY ข้าม POV\n\
         ...
         - ถ้าเจอ 互いに/お互い/向け合う/向き合う กับ 絆/関係/思い/気持 ให้แปลเป็นความสัมพันธ์/ความรู้สึกที่มีต่อกันหรือผูกพันกัน ไม่ใช่ \"มอบให้\" แบบการให้ฝ่ายเดียว\n\

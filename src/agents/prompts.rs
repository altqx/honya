...
4. การบังคับใช้คลังศัพท์: บังคับใช้ชื่อตัวละคร สถานที่ สกิล เวทมนตร์ และคำศัพท์เฉพาะให้ตรงกับ GLOSSARY.md อย่างเคร่งครัด ห้ามบัญญัติคำใหม่หากมีกำหนดไว้แล้ว

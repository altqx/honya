...
mod tests {
    ...
    fn translator_prompt_rejects_duplicate_parenthetical_term_renderings() {
        ...
        assert!(TRANSLATOR_SYSTEM.contains("`new_terms[].thai_term`"));

...
7c. แก้จาก REVIEWER_FEEDBACK อย่างตรงจุด: เมื่อมี feedback จากรอบก่อน ให้ถือว่าเป็นเงื่อนไขผ่าน/ตกของ retry นี้ ต้องแก้ทุกข้อที่ถูกระบุจริง ๆ ใน translated_text ฉบับเต็ม แล้วอ่านทวนทั้งชังก์อีกครั้ง อย่าแก้เฉพาะคำแรกแล้วปล่อยคำสะกดผิด รูบิที่ยังไม่เกลา เครื่องหมายญี่ปุ่น หรือชื่อ/สรรพนามที่ feedback ชี้ไว้อีกตำแหน่งหนึ่งให้ค้างอยู่ หาก feedback ล่าสุดขัดกับ CONTINUITY หรือคำแปลรอบก่อน ให้ยึด SOURCE_JP/REFERENCE และ feedback ล่าสุดก่อน

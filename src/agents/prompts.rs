...
4. รูบิ/ฟุริงานะ: ข้อความที่ผ่าน Pre-process จะเขียนรูบิเป็นรูปแบบ "คำฐาน (เสียงอ่าน)" เช่น 漢字 (かんじ) โดยปกติให้แปล "ความหมายของคำฐาน" เป็นภาษาไทยและตัดเสียงอ่านในวงเล็บทิ้ง ยกเว้นกรณีที่เสียงอ่านสื่อความหมายเพิ่มเติมที่คำฐานไม่ได้บอกไว้ (เสียงอ่านพิเศษ/อาเทจิ เสียงอ่านของชื่อเฉพาะ คำทับศัพท์ภาษาต่างประเทศ หรือการเล่นคำ) ให้ถ่ายทอดนัยนั้นออกมาเป็นภาษาไทยด้วย และห้ามทิ้งคะนะญี่ปุ่นดิบหรือวงเล็บเสียงอ่านค้างไว้ใน translated_text
...
2a. Ruby/Furigana Resolution: source ruby is pre-rendered as `Base (Reading)`, e.g. 漢字 (かんじ). The Thai must convey the base's meaning with the parenthetical reading dropped by default, EXCEPT where the reading carries meaning the base does not (special/ateji reading, a name's reading, a foreign-word gloss, or a pun) — there the nuance must surface in Thai. Reject output that leaves bare Japanese kana or a residual `(かな)` reading parenthetical in the Thai.

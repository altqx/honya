...
fn hand_written() -> Vec<Binding> {
    ...
    vec![
        ...
        b("type", "write a message", Scope::On(Refine)),
        b("↑ ↓", "move between transcript blocks", Scope::On(Refine)),
        b("← →", "fold · unfold the selected block", Scope::On(Refine)),
        b("Shift-↑ ↓", "jump to your previous · next turn", Scope::On(Refine)),
        b("Ctrl-R", "fold · unfold the whole transcript", Scope::On(Refine)),
        b("Ctrl-B", "copy the selected block", Scope::On(Refine)),
        b("Ctrl-G", "sub-agent tasks", Scope::On(Refine)),
        b("↵", "open the selected sub-agent", Scope::On(Refine)),
